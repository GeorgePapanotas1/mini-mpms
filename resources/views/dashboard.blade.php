                            ...
                            <div class="max-w-sm rounded overflow-hidden shadow-lg">
                                ...
                                <div class="px-6 py-4">
                                    ...
                                    @if ($practice->website_url)
                                        <p class="text-gray-700 text-base py-2"><a href="{{$practice->website_url}}" target="_blank">{{$practice->website_url}}</a></p>
                                    @endif
                                    <p class="text-gray-700 text-base"># of Employees: {{ $practice->employees_count }}</p>
                                </div>
